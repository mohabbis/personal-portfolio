  ...
  return (
    ...
    >
      ...
      <g className="joystick-tilt" style={{ transformOrigin: "13px 24px" }}>
        {/* Ball */}
        <rect x="9" y="4" width="8" height="8" fill="#1f2937" />
        <rect x="8" y="6" width="10" height="4" fill="#1f2937" />
        {/* Ball shine */}
        <rect x="10" y="5" width="2" height="2" fill="#94a3b8" opacity="0.55" />
        {/* Shaft */}
        <rect x="11" y="12" width="4" height="12" fill="#374151" />
      </g>
      {/* Base plate */}
      <rect x="0" y="22" width="32" height="12" fill="#1f2937" />
      <rect x="0" y="22" width="32" height="2" fill="#374151" />
      {/* Button A — red */}
      ...
      {/* Start button */}
      <rect x="3" y="28" width="6" height="2" fill="#4b5563" />
    </svg>
  );
}
