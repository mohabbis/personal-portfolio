...
function ResponsiveCamera() {
  ...
  useEffect(() => {
    ...
    camera.position.copy(new THREE.Vector3(26, 15, 32).normalize().multiplyScalar(portrait ? 56 : 42));
