...
export default function PhotographyPage() {
  return (
    <SiteFrame currentPath="/photography">
          ...
          <div className="relative isolate overflow-hidden rounded-[2rem] bg-black shadow-[0_24px_80px_rgba(43,31,24,0.18)] sm:rounded-[2.5rem]">
            <div className="relative aspect-[16/10] sm:aspect-[21/9] lg:aspect-[24/9]">
              <Image
                ...
                className="scale-[1.035] object-cover object-[50%_50%] opacity-85 blur-[5px] sm:blur-[4px]"
              />
              <div className="absolute inset-0 bg-black/18" />
              <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.06)_0%,rgba(0,0,0,0.16)_46%,rgba(0,0,0,0.64)_100%)] sm:bg-[linear-gradient(90deg,rgba(0,0,0,0.52)_0%,rgba(0,0,0,0.26)_42%,rgba(0,0,0,0.08)_100%)]" />
              <div className="absolute inset-x-0 bottom-0 p-5 text-white sm:p-8 lg:p-10">
                <div className="max-w-2xl">
                  <h1 className="font-display text-[clamp(2.35rem,6vw,5.25rem)] leading-[0.95] tracking-[-0.045em] text-white/92 drop-shadow-[0_3px_18px_rgba(0,0,0,0.7)]">
                    A Place Of Light
                  </h1>
      ...
      <section className="pb-2 pt-5 sm:pb-20 sm:pt-8 lg:pt-10">
        <Container>
          <PhotoGallery />
        </Container>
      </section>
