...
export const projects: ProjectItem[] = [
  {
    ...
    summary:
      "Lumen is the production-facing smart-home experience: warm, quiet, and interface-first. Muhome remains the supporting architecture for rooms, devices, scenes, sensors, routines, and infrastructure planning.",
